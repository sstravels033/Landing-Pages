        ...
        try {
            ...
            const svgStyles = `
                <style>
                    ...
                    .city-dot { fill: #00b8d4; opacity: 0.9; }
                    .city-hub { fill: #ff2d55; }
                    .city-label { fill: #3d3d4e; font-size: 15px; font-family: sans-serif; text-anchor: middle; font-weight: bold; stroke: white; stroke-width: 3px; paint-order: stroke; }
                    .hub-label { font-size: 16px; fill: #ff2d55; }
            ...
            const imagePath = 'samples/sample1.webp';
